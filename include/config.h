...
typedef struct {
  ...
  long n_nano_secs; /**< @brief Real-time nanoseconds equivalent to one
                       simulation minute */
  /** @} */
  ...
  /** @{ */
  int nof_wk_seats_primi;   /**< @brief Max queue capacity for the First Course
                               station */
  int nof_wk_seats_secondi; /**< @brief Max queue capacity for the Main Course
                               station */
  ...
  /** @{ */
  int avg_srvc_primi;   /**< @brief Average service time at the First Course
                           station */
  int avg_srvc_secondi; /**< @brief Average service time at the Main Course
                           station */
  ...
  int max_porzioni_primi;   /**< @brief Maximum number of First Course portions
                               per batch */
  int max_porzioni_secondi; /**< @brief Maximum number of Main Course portions
                               per batch */
  /** @} */
  ...
  int overload_threshold; /**< @brief Queue threshold to trigger worker
                             reallocation */
 ...
 *
 * @param path Pointer to the string containing the path, or NULL for default
 * behavior.
